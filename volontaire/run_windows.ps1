...
if (-not (Test-Path "venv\Scripts\Activate.ps1")) {
    Write-Error "Environnement virtuel introuvable. Executez d'abord install-volontaire.ps1"
}
if (-not (Test-Path "manage.py")) {
    Write-Error "Lancez ce script depuis le dossier volontaire (volunteer-app-2025\volontaire)"
}
