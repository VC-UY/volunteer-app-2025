                ...
                if success:
                    ...
                    def machine_info_from_raw(raw, username, password, volunteer_id=None):
                        ...
                        return {
                            ...
                            'machine_tipe': raw.get('machine_type', '') or raw.get('type_machine', ''),
                            'cpu_modele': raw.get('cpu', {}).get('type', ''),
            ...
            if self.volunteer_id:
                machine_info, created = MachineInfo.objects.get_or_create(
                    ...
                    defaults={
                        ...
                        'machine_tipe': self.static_data.get('type_machine', 'Indéterminé'),
                        'hostname': self.static_data.get('os', {}).get('hostname', ''),
                        'os_name': self.static_data.get('os', {}).get('nom', ''),
                        'os_release': self.static_data.get('os', {}).get('release', ''),
                        'os_version': self.static_data.get('os', {}).get('version', ''),
                        'os_architecture': self.static_data.get('cpu', {}).get('architecture', ''),
                        'cpu_modele': self.static_data.get('cpu', {}).get('type', ''),
                        'cpu_cores_physical': self.static_data.get('cpu', {}).get('coeurs_physiques', 1),
                        'cpu_cores_logical': self.static_data.get('cpu', {}).get('coeurs_logiques', 1),
