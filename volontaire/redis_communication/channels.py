...
class ChannelRegistry:
    ...
    DEFAULT_CHANNELS = {
        ...
        "task/assignment": "Assignation directe d'une tâche à un volunteer",
        "task/accept": "Acceptation d'une tâche par un volunteer",
        "task/start": "Démarrage d'une tâche par un volunteer",
        "task/progress": "Progression d'une tâche en cours",
        "task/status": "État des tâches en cours",
        "task/complete": "Notification de tâche terminée",
        "task/result": "Résultats des tâches terminées",
        "task/cancel": "Annulation d'une tâche",
        "task/file": "Transfert de fichiers liés aux tâches",
